...
Tissue / cohort / model:
- GTEx v10 Adipose - Visceral (Omentum), Female only.
...
- Program-level gene-set shifts (SMCENTER-adjusted; VST z-score) are summarized below (estimates and p-values are from linear models):
  - lipolysis_core: peri vs pre est=-0.009 p=0.9513; post vs pre est=-0.173 p=0.2269.
  - thermogenesis_program: peri vs pre est=-0.182 p=0.0383; post vs pre est=-0.206 p=0.0201.
  - acute_beta_adrenergic: peri vs pre est=-0.088 p=0.5211; post vs pre est=0.097 p=0.4791.
...
## Files to review
- Gene-set activity stats (pre/peri/post): `gene_set_activity_stats_visceral.tsv`
- Gene-set activity stats (40-49 vs 50-59): `gene_set_activity_stats_40-49_vs_50-59_visceral.tsv`
- Panel DE (strict pre vs post): `DE_strict2_post_vs_pre_PANEL_visceral.tsv`
- Candidate figure panels:
  ...
  - `GTEx_v10_AT_analysis_out/figs/kenichi_sns_panel/figure_candidate__acute_beta_adrenergic_visceral.png`
...
Generated: 2026-01-29 06:36:08.965734
