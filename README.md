...
**Signature / gene-set files (references/)**

- `references/menopause_signature_curated.tsv`
- `references/menopause_signature_senMayoLike_v1.tsv`
- `references/menopause_signature_senMayoLike_v1_evidence.tsv`
- `references/menopause_signature_senMayoLike_v2.tsv`
- `references/menopause_signature_senMayoLike_v2_evidence.tsv`
- `references/kenichi_panel_gene_sets.tsv` (panel gene sets used by `R/kenichi_sns_panel_analysis.R`)
- `references/kenichi_extra_gene_sets.tsv` (optional add-on gene sets; same format as panel file)

**Main outputs (docs/)**

- `docs/menopause_sns_gtex_enhanced_2026-02-02_v4.1.2.pptx`
- `docs/slide_revision_notes_v4.1.2.md`
- `docs/senMayoLike_v2_signature_details_2026-02-02.xlsx`
